...
Get Folder Dashboards Version 4.0.24.14 (latest)
Get the dashboards in a folder Request GET /folders/{folder_id}/dashboards

| GET /folders/{folder_id}/dashboards Datatype   | Description                     |                   |
|------------------------------------------------|---------------------------------|-------------------|
...
| 200: Dashboard 400: Bad Request…   | 404: Not Found…   | 429: Too Many Requests…   |
|------------------------------------|-------------------|---------------------------|
| (#200:-dashboard)                  | Datatype          | Description               |
| Dashboard  (/looker/docs/refer ence/lookerapi/latest/types/Da shboard) []                                    |                   |                           |
| (array)                            |                   |                           |

Model model lock LookModel
...
refresh_interval string folder lock FolderBase
...
| query_timezone                    | string                           | Timezone in which the Dashboard will run by default. Refresh Interval, as a time duration phrase like "2 hours 30 minutes". A number with no time units will be interpreted as whole seconds.   |
|-----------------------------------|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
dashboard_elements ent
 (/looker/docs/refe rence/lookerapi/latest/types/D
ashboardElement)
[]
...
| body_text_as_htmllock string | Text tile body text as Html |                                                                 |
| dashboard_id                 | string                      | Id of Dashboard Relative path of URI of LookML file to edit the |
| edit_uri                     | lock string                 | dashboard element (LookML dashboard only).                      |
| id                           | lock string                 | Unique Id                                                       |

look lock LookWithQuery
