- dashboard: bing_ads_impressions
  ...
  - title: Impressions By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_impressions,
            name: Keyword This Period Impressions, axisId: fact.total_impressions}],
  ...
  - title: Impressions By Network
    ...
    type: looker_bar
    fields: [fact.channel, fact.total_impressions]
    sorts: [fact.total_impressions desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    ...
    show_view_names: true
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_impressions,
            name: Fact Impressions, axisId: fact.total_impressions}], showLabels: false,
  ...
  - title: Impressions By Bid Strategy
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [keyword.bid_strategy_type, fact.total_impressions]
    sorts: [fact.total_impressions desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
  ...
  - title: Creative Impressions Change
    ...
    explore: bing_ad_date_fact
    type: looker_bar
    fields: [ad.title, ad_group.ad_group_name, campaign.campaign_name, last_fact.total_impressions_period_delta,
      last_fact.total_impressions, fact.total_impressions]
    filters:
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Ad Last Period, axisId: last_fact.total_impressions}, {id: fact.total_impressions,
            name: Ad This Period, axisId: fact.total_impressions}], showLabels: true,
        showValues: false, unpinAxis: false, tickDensity: default, type: linear}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Ad Group Impressions Change
    ...
    explore: bing_ad_group_date_fact
    type: looker_bar
    fields: [campaign.campaign_name, ad_group.ad_group_name, last_fact.total_impressions_period_delta,
      last_fact.total_impressions, fact.total_impressions]
    filters:
      fact.total_conversions_period_delta_abs: ">0"
    sorts: [last_fact.total_impressions_period_delta desc]
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Ad Group Last Period, axisId: last_fact.total_impressions}, {id: fact.total_impressions,
            name: Ad Group This Period, axisId: fact.total_impressions}], showLabels: true,
        showValues: false, unpinAxis: false, tickDensity: default, type: linear}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Landing Pages Impressions Change
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [ad_group.ad_group_name, campaign.campaign_name, last_fact.total_impressions_period_delta,
      last_fact.total_impressions, fact.total_impressions]
    filters:
      fact.total_conversions_period_delta_abs: ">0"
    sorts: [last_fact.total_impressions_period_delta desc]
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Keyword Prior Period, axisId: last_fact.total_impressions}, {id: fact.total_impressions,
            name: Keyword This Period, axisId: fact.total_impressions}], showLabels: true,
        showValues: false, unpinAxis: false, tickDensity: default, type: linear}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    hidden_fields: [campaign.name, campaign.campaign_name, last_fact.total_impressions_period_delta]
    listen:
      Period: fact.period
      Period Latest: fact.date_period_latest
      Campaign: campaign.campaign_name
